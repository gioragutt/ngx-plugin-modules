...
export const LAZY_PLUGIN_MODULES = new InjectionToken<LazyPluginModule[]>(
  'LAZY_PLUGIN_MODULES'
);

export const PLUGIN_PROCESSORS = new InjectionToken<PluginProcessor[]>(
  'PLUGIN_PROCESSORS'
);

export function providePluginProcessor<P extends PluginProcessor>(
  t: Type<P>
): Provider {
  return {
